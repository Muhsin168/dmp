...
% addpath('/home/muhsin/workspaces/plots/altmany-export_fig-3.46.0.0'); % Add the path to export_fig (commented out as using built-in saveas)

% Save plot as PDF
% export_fig('2d_damp.pdf', '-pdf', '-q100', '-nocrop', '-transparent');

saveas(gcf, 'GA_box.pdf');